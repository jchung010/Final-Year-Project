...
//const char* ssid = "TP-LINK_C6D8";
//const char* password = "85721470";

//const char* ssid = "M1-9301";
//const char* password = "8316472680";

const char* ssid = "Juju";
const char* password = "happycow1234";
...
String chatId = "641860372";

// Initialize Telegram BOT
String BOTtoken = "5399723537:AAGxBFOP0Yfxu6-8R4Rtkgoh8wkIX37Mb0w";
...
// MQ2 Smoke LPG gas leak Detector
...
void setup(){
  ...
  // Set PIR sensor as input and LEDs as output
  pinMode(buzz, OUTPUT);
  ...
  delay(40000); // Give time for PIR and MQ2 Gas Sensor to get Stable
...
String sendPhotoTelegram(){
  ...
  if (secured_client.connect(myDomain, 443)) {
    ...
    secured_client.println("Content-Type: multipart/form-data; boundary=make2explore");
...
void handleNewMessages(int numNewMessages){
  ...
  for (int i = 0; i < numNewMessages; i++){
    ...
    if (text == "/start"){
      String welcome = "Welcome to the Julian's ESP32-CAM Telegram bot.\n\n";
